							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										...
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">You have<b id="notifications_count" style="color: yellow;"> {{ auth()->user()->unreadNotifications->count() }}</b> unread Notifications
									...
									<div class="main-notification-list Notification-scroll">
										<a class="d-flex p-3 border-bottom" href="/certifs/check/{{$notification->data['id']}}">
										<div class="notifyimg bg-pink">
											...
											<div class="mr-3">
												...
												<div class="notification-subtext">{{ $notification->created_at }}</div> <hr>
